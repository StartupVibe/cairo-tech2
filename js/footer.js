    ...
    <div class="row w-100">
      ...
      <div class="col-12 col-lg-3">
        ...
        <p style="font-weight:bold;" id="main-office">Main office :</p>
          <div class="icon mb-2">
            <p id="info-address">7 Philistine St, New Maadi. Cairo. Egypt.</p>
          </div>
          <p style="font-weight:bold;" id="factory">Factory : </p>
          <div class="icon">
            <p>Block 20027-El Obour industrial area, 2nd zone</p>
          </div>
          <p style="font-weight:bold;" id="KSA-branch">KSA branch : </p>
          <div class="icon">
            <p>7864 Madinah Road Branch - Al Salamah District, Jeddah</p>
          </div>
        </div>
      </div>
      <div class="col-12 col-lg-3">
        ...
        <div class="information">
          <div class="icon d-flex align-items-center gap-2 mt-2">
